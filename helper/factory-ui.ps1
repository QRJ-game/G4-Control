...
Write-Host "Disabling automatic custom UI activation..."
...
Write-Host "Factory UI is active and will remain active after reboot."
Write-Host "Open http://192.168.0.1/index.html"
