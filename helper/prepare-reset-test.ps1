...
& $Adb shell "echo etc_rw > /etc_rw/g4-reset-probe"
& $Adb shell "echo userdata > /mnt/userdata/g4ui/reset-probe-userdata"
& $Adb shell "echo tmp > /tmp/g4-reset-probe"

Write-Host "Reset probes created:"
Write-Host "  /etc_rw/g4-reset-probe"
Write-Host "  /mnt/userdata/g4ui/reset-probe-userdata"
Write-Host "  /tmp/g4-reset-probe"
Write-Host ""
Write-Host "Now perform the physical factory reset."
Write-Host "After the router boots, run check-reset-test.ps1."
